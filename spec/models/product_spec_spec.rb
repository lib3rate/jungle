...
RSpec.describe Product, type: :model do
  ...
  describe 'Validations' do
    ...
    it "does not create a product if the name is not provided" do
      subject.name = nil
      expect(subject).to_not be_valid
      expect(subject.errors.full_messages).to include "Name can't be blank"
    end

    it "does not create a product if the price is not provided" do
      subject.price_cents = nil
      expect(subject).to_not be_valid
      expect(subject.errors.full_messages).to include "Price can't be blank"
    end

    it "does not create a product if the quantity is not provided" do
      subject.quantity = nil
      expect(subject).to_not be_valid
      expect(subject.errors.full_messages).to include "Quantity can't be blank"
    end

    it "does not create a product if the category is not provided" do
